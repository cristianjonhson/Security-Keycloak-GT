package cl.edu.galaxy.training.apps.siac.api_gestion_academica.restcontroller;
...
public class DemoREST {
	...
	@GetMapping("/v6.1")
	public ResponseEntity<Map<String, Object>> demov6_1(
	...
	@GetMapping("/v7")
	public ResponseEntity<Map<String, Object>> demov7(@RequestParam("company") String company,
	...
	public ResponseEntity<CompanyEntity> update(@PathVariable("id") Long id, @PathVariable("idPais") Long idPais,
	...
	public ResponseEntity<CompanyEntity> update(@PathVariable("id") Long id, @PathVariable("company") String company,
			@PathVariable("contact") String contact, @PathVariable("country") String country) {
		log.info("id, {}", id);
		log.info("company,{}", company);
	...
	@PatchMapping("/{id}")
	public ResponseEntity<CompanyEntity> updatePartial(@PathVariable("id") Long id,
			@RequestBody CompanyEntity company) {
		log.info("id, {}", id);
		log.info("Company, {}", company);
		company.setCompany(company.getCompany().toUpperCase());
